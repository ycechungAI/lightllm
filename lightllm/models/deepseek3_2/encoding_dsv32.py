# Adapted from vLLM's deepseek_v32_encoding.py
# (https://github.com/vllm-project/vllm), which was originally adapted from
...
def render_message(index, messages, thinking_mode):
...
def parse_tool_calls(index, text):
    tool_calls = []
    stop_token = None
